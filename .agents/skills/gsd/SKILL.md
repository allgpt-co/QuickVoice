---
name: gsd
description: Get Shit Done (GSD) - A comprehensive project management system for solo developers using Codex agents
version: 1.0.0
author: GSD Project
...
A comprehensive project management system designed for solo developers working with Codex AI agents. GSD provides structured workflows for project initialization, planning, execution, verification, and debugging.
...
- **Solo Developer + Codex Workflow** - No teams, no stakeholders, no ceremonies
